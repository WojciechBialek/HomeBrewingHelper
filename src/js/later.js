                        ...
                        <g id="Page-1" fill="none" fill-rule="evenodd">
                            <g id="Course-Template">
                                ...
                                <g id="ep-content" class="ep-svg-block"
                                   onClick="{{ display = true; selected = 'ep-content' }}"
                                ...
                                <g id="ep-form" class="ep-svg-block"
                                   onClick="{{ display = true; selected = 'ep-form' }}"
                                ...
                                <g id="ep-media" class="ep-svg-block"
                                   onClick="{{ display = true; selected = 'ep-media' }}"
                                ...
                                <g id="ep-unity" class="ep-svg-block"
                                   onClick="{{ display = true; selected = 'ep-unity' }}"
                                ...
                                <g id="ep-elements" class="ep-svg-block"
                                   onClick="{{ display = true; selected = 'ep-elements' }}"
                                ...
                                <g id="ep-principles" class="ep-svg-block"
                                   onClick="{{ display = true; selected = 'ep-principles' }}"
